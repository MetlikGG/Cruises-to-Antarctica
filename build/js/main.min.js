...
window.addEventListener('DOMContentLoaded', function () {
  var control = document.querySelector('[data-validate="control"]');
  var submit = document.querySelector('[data-validate="submit"]');
  var data = document.querySelector('[data-validate="data"]');
...
var Form = /*#__PURE__*/function () {
  ...
  _createClass(Form, [{
    ...
    value: function reset(form) {
      ...
      form.querySelectorAll('.booking__message').forEach(function (item) {
        return item.remove();
      });
      setTimeout(function () {
...
var Message = /*#__PURE__*/function () {
  ...
  _createClass(Message, [{
    ...
    value: function _messageTemplate(message, state) {
      ...
      return "<span class=\"booking__message ".concat(cssClass, "\">").concat(message, "</span>");
    }
  }, {
    key: "removeMessage",
    value: function removeMessage(parent) {
      var parentMessage = parent.querySelector('.booking__message');
      if (parentMessage) {
        parentMessage.remove();
      }
    }
...
function init() {
  ...
  var myPlacemark = new ymaps.Placemark([59.937468, 30.322623], {
    balloonContent: ''
  }, {
